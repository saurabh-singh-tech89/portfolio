...
const projects = [
  {
    ...
    github: "https://github.com/saurabh-singh-tech89",
    description:
      "The Course Management System is an innovative web-based application designed to streamline course creation, enrollment, and progress tracking. It incorporates interactive learning modules, user management, and performance analytics to enhance student engagement, promote seamless communication, and drive educational excellence.",
    image: GlobalShare,
  },
  {
    ...
    github: "https://github.com/saurabh-singh-tech89",
    description:
      "The Learning Management System (LMS) is an innovative web-based application designed to streamline course creation, student enrollment, and progress tracking. It incorporates interactive learning modules, assessments, and certification management to enhance student engagement, promote seamless communication, and drive educational excellence.",
    image: Ataa,
  },
  // {
  // 	name: 'SoKo Number',
      ...
      <div id="Home" className={style.home}>
        ...
        <div className={style["contact-nav"]}>
          <a
            ...
            target="_blank"
            href="https://github.com/saurabh-singh-tech89"
          >
          ...
          <a
            ...
            target="_blank"
            href="https://www.linkedin.com/in/saurabh-singh89/"
          >
          ...
          <a
            ...
            target="_blank"
            href="mailto:saurabhsingh.tech89@gmail.com?subject=SendMail&body=Description"
          >
      ...
      <div className={style.footer}>
        <div className={style.container}>
          ...
          <div className={style["copy-right"]}>
            © Copyright 2023. Made by <span>Saurabh Singh</span>
          </div>
        </div>
      </div>
    </div>
